# 네트워크 기초
> 개요
- 소켓 프로그래밍, HTTP 요청 및 응답 처리, RESTful API 개념, 웹 스크레이핑 기법 등 네트워크 프로그래밍 관련 내용을 다루고 있음
- 소켓 프로그래밍에서는 소켓의 개념, TCP/IP, UDP 프로토콜을, HTTP 요청 및 응답 처리에서는 HTTP 프로토콜과 요청 메서드, Python에서의 HTTP 요청 및 응답 처리를 설명함
- RESTful API, 웹 스크레이핑에 대한 기본적인 이해와 Python에서의 구현 방법을 제공함##(1) 
